...
public class CanGo {
    ...
    public boolean white(int i, int j, int iNext, int jNext, Field[][] fields) { /** sprawdzam czy jest to plansza na którą mogę się ruszyć */
    ...
    public boolean black(int i, int j, int iNext, int jNext, Field[][] fields) { /** sprawdzam czy jest to plansza na którą mogę się ruszyć */
